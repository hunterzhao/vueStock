    ...
    <v-app id="inspire">
	    ...
	    <v-container fluid grid-list-md text-md-center>
	         <v-layout row wrap>
                                                ...
                                                <v-layout row wrap>
                                                     ...
                                                     <v-flex md6>
			                                             <v-card dark color="secondary" height="300px">
			                                                 ...
			                                                 <v-form v-model="valid" class="padding-10">
															      <v-text-field
															        label="预测n日期"
															        v-model="predict_num"
															        :rules="nameRules"
		                                             ...
		                                             <v-flex md6>
			                                             <v-card dark color="secondary" height="300px">
															 ...
															 <v-layout row wrap class="padding-10">
															     <v-flex md6>
															     <p>SVM类型</p>
	                                                             <v-select v-bind:items="svm_type" overflow label=""></v-select>
	                                                             </v-flex>
	                                                          
	                                                             <v-flex md6>
	                                                             <p>核函数类型</p>
	                                                             <v-select v-bind:items="kernel_type" overflow label=""></v-select>
	                                                             </v-flex>
                                                             </v-layout>
			                                             </v-card>
		                                             </v-flex>
		                                             ...
		                                             <v-flex md6>
			                                             <v-card dark color="secondary" height="450px">
			                                                 ...
			                                                 <v-card-text >
			                                                        <p class="text-md-left"><span>maxrelative_error  :  8.175</span></p>
			                                                        <p class="text-md-left"><span>max_absolute_error :  297.77</span></p>
			                                                        <p class="text-md-left"><span>relativer error < 1:  0.295</span></p>
			                                                        <p class="text-md-left"><span>relativer error < 2:  0.47</span></p>
			                                                        <p class="text-md-left"><span>relativer error < 3:  0.72</span></p>
			                                                        <p class="text-md-left"><span>relativer error < 5:  0.925</span></p>
													         </v-card-text>
			                                             </v-card>
		                                             </v-flex>
                 ...
                 <v-flex md7>
			          <v-card dark color="secondary" height="460">
			                <h2>煤炭石油</h2>  
			          ...
			          <v-layout row wrap>
			               <v-flex d-flex>
				               <v-card dark color="secondary" height ="100">
				                   <h2>5日后指数预测值</h2>
		                           <v-card-text><span>3891</span></v-card-text>
				               </v-card>
			               </v-flex>
			               <v-flex d-flex>
				               <v-card dark color="secondary" height="350">
				                   <h2>舆论热度值</h2>
...
export default{
        ...
        data() {
        	return {
		      ...
		      sound: true,
		      widgets: false,
		      svm_type: ['C-SVC', 'nu-SVC', 'one-class SVM', 'epsilon-SVR', 'nu-SVR'],
		      kernel_type: ['linear', 'polynomial', 'radial', 'sigmoid'],
		      headers: [
		        {
		          text: '板块成分股',
		          align: 'left',
